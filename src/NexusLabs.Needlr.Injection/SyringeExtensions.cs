...
public static class SyringeExtensions
{
    ...
    /// <summary>
    /// Configures the syringe to use a source-generated type registrar.
    /// This registrar uses compile-time generated registration code instead of runtime reflection,
    /// eliminating the performance overhead of assembly scanning and type inspection.
    /// </summary>
    /// <param name="syringe">The syringe to configure.</param>
    /// <param name="registerAction">
    /// The action containing the generated registration code. This is typically generated by a 
    /// C# Source Generator that analyzes the codebase at compile time.
    /// </param>
    /// <returns>A new configured syringe instance.</returns>
    /// <example>
    /// <code>
    /// // This method would typically be generated by a source generator
    /// static void GeneratedRegistrations(IServiceCollection services)
    /// {
    ...
    /// 
    /// var syringe = new Syringe()
    ///     .UsingSourceGeneratedTypeRegistrar(GeneratedRegistrations)
    ///     .UsingDefaultTypeFilterer()
    ///     .UsingDefaultAssemblyProvider();
    /// </code>
    /// </example>
    public static Syringe UsingSourceGeneratedTypeRegistrar(
        this Syringe syringe,
        Action<IServiceCollection> registerAction)
    {
        ...
        return syringe.UsingTypeRegistrar(
            new SourceGeneratedTypeRegistrar(registerAction));
    }
}