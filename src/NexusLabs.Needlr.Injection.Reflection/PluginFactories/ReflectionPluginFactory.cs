...
namespace NexusLabs.Needlr.Injection.Reflection.PluginFactories;

/// <summary>
/// Plugin factory that uses runtime reflection to scan assemblies for types that implement specified interfaces,
...
/// For AOT scenarios, use the GeneratedPluginFactory from NexusLabs.Needlr.Injection.SourceGen instead.
/// </remarks>
[RequiresUnreferencedCode("ReflectionPluginFactory uses reflection to discover and instantiate plugins. Use GeneratedPluginFactory for AOT scenarios.")]
public sealed class ReflectionPluginFactory : IPluginFactory
{
    /// <inheritdoc />
    /// <remarks>
