...
public sealed class IntegrationExampleWorker : BackgroundService
{
    ...
    {
        _logger.LogInformation("IntegrationExampleWorker (SourceGen) starting at: {Time}", DateTimeOffset.Now);
        ...
        _logger.LogInformation("IntegrationExampleWorker (SourceGen) stopping at: {Time}", DateTimeOffset.Now);
    }
}
