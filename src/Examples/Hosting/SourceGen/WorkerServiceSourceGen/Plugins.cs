...
/// <summary>
/// Example plugin that demonstrates IHostApplicationBuilderPlugin with source generation.
...
public sealed class ExampleHostApplicationBuilderPlugin : IHostApplicationBuilderPlugin
{
    ...
    {
        options.Logger.LogInformation("ExampleHostApplicationBuilderPlugin: Configuring (SourceGen)...");
...
/// <summary>
/// Example plugin that demonstrates IHostPlugin with source generation.
...
public sealed class ExampleHostPlugin : IHostPlugin
{
    public void Configure(HostPluginOptions options)
    {
        ...
        log?.LogInformation("ExampleHostPlugin: Host has been built (SourceGen). Performing post-build configuration...");
