...
// CreateResearchPipelineGraphWorkflow() is generated by the source generator because
// AnalyzerAgent is decorated with [AgentGraphEntry("research-pipeline")].
var workflow = workflowFactory.CreateResearchPipelineGraphWorkflow();
...
Console.WriteLine("  Pattern:   Fan-out from analyzer, fan-in at summarizer (WaitAll)");
Console.WriteLine();
...
var responses = await workflow.RunAsync(question);
