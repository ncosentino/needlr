...
await new NeedlrSerilogBootstrapper()
    ...
    .RunAsync(async (context, ct) =>
    {
        var webApplication = new Syringe()
            ...
            .BuildWebApplication();
        var webAppTask = webApplication.RunAsync(ct);
        ...
        Console.WriteLine("─── 4. Serilog bootstrap ───");
        Console.WriteLine("  NeedlrSerilogBootstrapper wired the pre-DI logger and will");
        Console.WriteLine("  flush Serilog automatically when the application exits.");
        Console.WriteLine();
