...
/// <summary>
/// Truth tables for every <c>UsingOnlyAsSingleton</c> overload, covering the cross product of the
/// underlying filterer results, target assignability, and the additional predicate result.
/// </summary>
public sealed class UsingOnlyAsSingletonTruthTableTests
{
    [Theory]
    ...
    [InlineData(false, true, false, true, false, false, true)]
    ...
    public void UsingOnlyAsSingletonOfT_TruthTable(
        bool innerScoped,
        bool innerTransient,
        bool innerSingleton,
        ...
        bool expectedSingleton)
    {
        var filterer = new ConfigurableTypeFilterer(innerScoped, innerTransient, innerSingleton)
            .UsingOnlyAsSingleton<ITruthTableTarget>();
    ...
    [InlineData(false, false, false, true, true, false, false, true)]
    ...
    [InlineData(false, false, true, true, true, false, false, true)]
    ...
    [InlineData(false, true, false, true, true, false, false, true)]
    ...
    [InlineData(false, true, true, true, true, false, false, true)]
    ...
    [InlineData(true, false, true, true, true, false, false, true)]
    ...
    [InlineData(true, true, false, true, true, false, false, true)]
    ...
    [InlineData(true, true, true, true, true, false, false, true)]
    public void UsingOnlyAsSingletonOfTWithPredicate_TruthTable(
        bool innerScoped,
        bool innerTransient,
        bool innerSingleton,
        bool assignableToTarget,
    ...
    {
        var filterer = new ConfigurableTypeFilterer(innerScoped, innerTransient, innerSingleton)
            .UsingOnlyAsSingleton<ITruthTableTarget>(_ => predicateResult);
    ...
    [InlineData(true, true, true, false, true, true, true)]
    [InlineData(true, true, true, true, false, false, true)]
    public void UsingOnlyAsSingletonWithPredicate_TruthTable(
        bool innerScoped,
        bool innerTransient,
        bool innerSingleton,
        bool predicateResult,
    ...
    {
        var filterer = new ConfigurableTypeFilterer(innerScoped, innerTransient, innerSingleton)
            .UsingOnlyAsSingleton(_ => predicateResult);
