...
public sealed class TypeRegistryGenerator : IIncrementalGenerator
{
        ...
        bool includeSelf)
    {
        ...
        if (includeSelf)
        {
            CollectTypesFromAssembly(compilation.Assembly, prefixList, injectableTypes, pluginTypes, hubRegistrations, compilation);
        }
        ...
        foreach (var reference in compilation.References)
        {
            ...
            {
                CollectTypesFromAssembly(assemblySymbol, prefixList, injectableTypes, pluginTypes, hubRegistrations, compilation);
            }
        }

        return new DiscoveryResult(injectableTypes, pluginTypes, hubRegistrations);
    }
