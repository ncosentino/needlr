...
internal static class DiagnosticDescriptors
{
    ...
    // ============================================================================
    // Generated Constructor Suggestions (NDLRGEN063)
    // ============================================================================

    /// <summary>
    /// NDLRGEN063: A hand-written constructor is mechanically replaceable by
    /// Needlr's generated-constructor feature.
    /// </summary>
    public static readonly DiagnosticDescriptor GenerateConstructorSuggested = new(
        id: "NDLRGEN063",
        title: "Constructor can be generated by Needlr",
        messageFormat: "Constructor for type '{0}' can be replaced by Needlr's generated-constructor feature without changing its parameter signature or supported guard behavior",
        category: Category,
        defaultSeverity: DiagnosticSeverity.Info,
        isEnabledByDefault: true,
        description: "The type has one public constructor whose parameters, supported guard calls, and private readonly field assignments exactly match a constructor Needlr can generate. Apply [GenerateConstructor] and any required [ConstructorGuard] attributes to remove the hand-written boilerplate. This advisory diagnostic can be promoted through .editorconfig when a project requires generated constructors.",
        helpLinkUri: HelpLinkBase + "NDLRGEN063.md");
