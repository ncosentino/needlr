...
internal sealed class BreadcrumbWriter
{
    ...
    public void WriteFileHeader(StringBuilder sb, string assemblyName, string fileDescription)
    {
        ...
        // Suppress obsolete-type warnings in generated code. Consumers may mark types
        // [Obsolete] to signal "migrate away" while still needing them in DI. Skipping
        // their registration would silently break injection; suppressing the warning
        // lets the typeof() reference compile under TreatWarningsAsErrors.
        sb.AppendLine("#pragma warning disable CS0618 // Type or member is obsolete");
        sb.AppendLine("#pragma warning disable CS0619 // Type or member is obsolete (error-level)");
